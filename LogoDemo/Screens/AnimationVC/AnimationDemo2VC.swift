...
class AnimationDemo2VC: UIViewController {
    var fullSize: CGSize!
    var myLabel: UILabel!
    ...
    func createButtonsAndLabel() {
            ...
            btn.addTarget(nil, action: #selector(AnimationDemo2VC.AnimateBounds), for: .touchUpInside)
            ...
            btn.setTitleColor(UIColor.blue, for: .normal)
            btn.addTarget(nil, action: #selector(AnimationDemo2VC.AnimateAlpha), for: .touchUpInside)
            ...
            btn.setTitleColor(UIColor.blue, for: .normal)
            btn.addTarget(nil, action: #selector(AnimationDemo2VC.AnimateBackgroundColor), for: .touchUpInside)
            ...
            btn.setTitleColor(UIColor.blue, for: .normal)
            btn.addTarget(nil, action: #selector(AnimationDemo2VC.AnimateCenter), for: .touchUpInside)
            ...
            btn.setTitleColor(UIColor.blue, for: .normal)
            btn.addTarget(nil, action: #selector(AnimationDemo2VC.AnimateTransform), for: .touchUpInside)
            btn.center = CGPoint(x: fullSize.width * 0.25, y: fullSize.height - 4.5 * btnHeight)//
            self.view.addSubview(btn)
            
            btn = UIButton(frame: CGRect(x: 0, y: 0, width: fullSize.width * 0.5, height: btnHeight))
            btn.setTitle("all", for: .normal)
            btn.setTitleColor(UIColor.blue, for: .normal)
            btn.addTarget(nil, action: #selector(AnimationDemo2VC.AnimateAll), for: .touchUpInside)
            btn.center = CGPoint(x: fullSize.width * 0.75, y: fullSize.height - 4.5 * btnHeight)//
            self.view.addSubview(btn)
